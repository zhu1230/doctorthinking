...
base_path = "#{RAILS_ROOT}/public/images/"
base_dir  = Dir.new(base_path) rescue return
size=File.size(base_path+"nophoto.jpg")
type="image/jpg"

puts f.size
sleep 5
ProfilePhoto.create!(:user_id=>0, :is_profile=>true,:size=>3997,:filename=>"nophoto.jpg",:content_type=>type,:width=>158,:height=>158)
ProfilePhoto.create!(:size=>2483,:filename=>"nophoto_medium.jpg",:parent_id=>1,:content_type=>type,:thumbnail=>"medium",:width=>96,:height=>96)
ProfilePhoto.create!(:size=>2483,:filename=>"nophoto_thumb.jpg",:parent_id=>1,:content_type=>type,:thumbnail=>"thumb",:width=>48,:height=>48)
