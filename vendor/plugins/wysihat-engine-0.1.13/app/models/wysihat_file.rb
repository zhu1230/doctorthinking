class WysihatFile < ActiveRecord::Base
  ...
  has_attached_file :file,:styles => { :medium => "300x300>", :thumb => "100x100>"},:path => ":rails_root/public/system/wysihat/:id/:style/:filename",:url => "/system/wysihat/:id/:style/:filename"
