	...
	module SuperInplaceControls
		...
		module HelperMethods
			...
			def in_place_field(field_type, object, method, options)
				...
				ret << external_control(object_name, method_name, @object,options)
			end
			...
			def external_control(object_name, method_name, object, options)
			...
			def cancel_link(id_string)
				link_to_function( "取消", update_page do |page|
					page.show "#{id_string}"
					page.hide "#{id_string}_form"
