...
with_page_views :buffer_size => 5, :days => 1, :model_name => 'user'
  ...
  # has_many :bingli_info_ranks,:class_name=>"UsersRankBingliInfos"
...
def delete_reset_code  
  ...
  validates_length_of       :about_me,  :maximum => 1500, :allow_nil => true,:too_long => I18n.t("activerecord.errors.messages.bingli_info.title.too_long_content")
...
#  end
  ...
  def self.admins
     Role.find_by_rolename('admin') ? Role.find_by_rolename('admin').users : Array.new
  end
  
  
  # Return the site creators
  def self.creators
    Role.find_by_rolename('creator') ? Role.find_by_rolename('creator').users : Array.new
  end
